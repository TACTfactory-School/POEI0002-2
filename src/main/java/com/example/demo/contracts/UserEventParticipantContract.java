...
public class UserEventParticipantContract extends BaseContract {
    ...
    public final static String TABLE = "ovg_user_event_participant";
    ...
    public final static String COL_USER = "participant_id";
    public final static String COL_EVENT = "event_id";

    public final static String EVENT_PARTICIPANT = "eventParticipant";
    public final static String USER_PARTICIPANT = "userParticipant";
    ...
    public UserEventParticipantContract() {
