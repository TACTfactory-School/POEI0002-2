...
public class UserLanguageContract extends BaseContract {

    public final static String TABLE = "ovg_user_language";
    ...
    public final static String COL_LANGUAGE = "language_id";

    public final static String LANGUAGE = "language";
    public final static String USER_LANGUAGE = "user";
    ...
    public final static String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS "+ TABLE +"(" +
            ...
            COL_LANGUAGE + " int NOT NULL" +
            ")";

    public UserLanguageContract() {
